...
var SmartActionHook = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(SmartActionHook, [{
    ...
    key: "getResponse",
    value: function () {
      var _getResponse = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(hook, fields, record, recordId) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 13:
                return _context.abrupt("return", fields.map(function (field) {
                  var updatedField = result[field.field]; // Reset `value` when not present in `enums` (which means `enums` has changed).

                  if (Array.isArray(updatedField.enums)) {
                    // `Value` can be an array if the type of fields is `[x]`
                    if (Array.isArray(updatedField.type) && Array.isArray(updatedField.value) && updatedField.value.some(function (value) {
                      return !updatedField.enums.includes(value);
                    })) {
