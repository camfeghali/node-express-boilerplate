  ...
  this.getDateFilter = function (operator, value) {
    ...
    switch (operator) {
      ...
      case 'before_x_hours_ago':
        return (0, _defineProperty2["default"])({}, options.operators.LTE, (0, _momentTimezone["default"])().subtract(value, 'hours').toDate());

      case 'after_x_hours_ago':
        return (0, _defineProperty2["default"])({}, options.operators.GTE, (0, _momentTimezone["default"])().subtract(value, 'hours').toDate());
