...
module.exports = function Stats(app, model, Implementation, opts) {
  ...
  this.perform = function () {
    app.post(path.generate("stats/".concat(modelName), opts), auth.ensureAuthenticated, permissionMiddlewareCreator.statWithParameters(), _this.get);
    app.post(path.generate('stats', opts), auth.ensureAuthenticated, permissionMiddlewareCreator.liveQueries(), _this.getWithLiveQuery);
  };
};