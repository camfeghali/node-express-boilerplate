  ...
  (0, _createClass2["default"])(Actions, [{
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.model ? new this.implementation.ResourceGetter(this.model, {
                  recordId: recordId
                }).perform() : null);
    ...
    value: function () {
      var _getHook = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(request, response, hook) {
        var recordId, record, updatedFields;
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                recordId = request.body.recordIds[0];
                _context2.next = 3;
              ...
              case 11:
                ...
                this.logger.error('Error in smart action hook: ', _context2.t0);
    ...
    value: function getHookLoadController(action) {
      ...
      return /*#__PURE__*/function () {
        var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(request, response) {
          return _regenerator["default"].wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  return _context4.abrupt("return", _this2.getHook(request, response, /*#__PURE__*/function () {
                    var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(record, recordId) {
                      return _regenerator["default"].wrap(function _callee3$(_context3) {
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              return _context3.abrupt("return", _this2.smartActionHook.getResponse(action.hooks.load, action.fields, record, recordId));
    ...
    value: function getHookChangeController(action) {
      ...
      return /*#__PURE__*/function () {
        var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(request, response) {
          var changedField;
          return _regenerator["default"].wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  changedField = request.body.changedField;
                  return _context6.abrupt("return", _this3.getHook(request, response, /*#__PURE__*/function () {
                    var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(record, recordId) {
                      return _regenerator["default"].wrap(function _callee5$(_context5) {
                        while (1) {
                          switch (_context5.prev = _context5.next) {
                            case 0:
                              return _context5.abrupt("return", _this3.smartActionHook.getResponse(action.hooks.change[changedField], request.body.fields, record, recordId));
    ...
    value: function buildRoutes(actions) {
      ...
      actions.forEach(function (action) {
        ...
        if (action.values) {
          _this4.logger.warn('DEPRECATION WARNING: Declaring `values` in a Smart Action is deprecated. Please use `load` hook.');
