...
function initAuthenticationRoutes(app, options, context) {
  ...
  app.post(context.pathService.generate(START_AUTHENTICATION_ROUTE, options), startAuthentication.bind(undefined, context));
  app.get(context.pathService.generate(CALLBACK_AUTHENTICATION_ROUTE, options), authenticationCallback.bind(undefined, context, options));
  app.post(context.pathService.generate(LOGOUT_ROUTE, options), logout.bind(undefined, context));
}
