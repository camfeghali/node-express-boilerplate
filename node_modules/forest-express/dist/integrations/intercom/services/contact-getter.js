  ...
  (0, _createClass2["default"])(ContactGetter, null, [{
    ...
    value: function () {
      var _getContact = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(intercomClient, Implementation, mappingValue, recordId) {
        var _context$inject, modelsManager, _mappingValue$split, _mappingValue$split2, modelName, modelFieldName, model, customer, targetFieldValue, queryParameter;

        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context$inject = context.inject(), modelsManager = _context$inject.modelsManager; // NOTICE: `modelFieldName` is expected to be a sequelize/mongoose field
